...
public class FieldConstants {
  ...
  public static final AprilTagLayoutType defaultAprilTagType = AprilTagLayoutType.ROBOCON;
  public static final AprilTagFieldLayout aprilTagLayout = defaultAprilTagType.getLayout();
  ...
  public enum AprilTagLayoutType {
    ...
    NONE("2026-none"),
    ROBOCON("2026-robocon-welded-photonvision-wpilib", true);

    private final String name;
    private final boolean deployRoot;
    ...
    AprilTagLayoutType(String name, boolean deployRoot) {
      this.name = name;
        ...
        synchronized (this) {
          if (layout == null) {
            try {
              ...
              Path p =
                  deployRoot
                      ? deployDirectory.resolve(name + ".json")
                      : deployDirectory
                          .resolve("apriltags")
