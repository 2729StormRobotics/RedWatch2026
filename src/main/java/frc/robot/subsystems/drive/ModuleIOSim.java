...
public class ModuleIOSim implements ModuleIO {
  ...
  private DCMotorSim driveSim =
      new DCMotorSim(
          LinearSystemId.createDCMotorSystem(DCMotor.getNeoVortex(1), 0.025, 4.71), DCMotor.getNeoVortex(1));
  ...
  public ModuleIOSim() {
    // -------------------------------------------------------------------------
    // CRITICAL FIX: ENABLE CONTINUOUS INPUT
    // This tells the Sim PID that -PI and PI are the same point.
    // -------------------------------------------------------------------------
