...
public final class FlywheelConstants {
  /** CAN IDs */
  public static final int LEADER_MOTOR_ID = FLYWHEEL_LEADER_ID;
  public static final int FOLLOWER_MOTOR_ID = FLYWHEEL_FOLLOWER_ID;
  ...
  public static final double kF = 0.0002; // Feedforward gain
