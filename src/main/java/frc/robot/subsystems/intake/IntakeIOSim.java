...
public class IntakeIOSim implements IntakeIO {
  ...
  // Constructor no longer requires DriveTrainSimulation
  public IntakeIOSim() {
  ...
  public void updateInputs(IntakeIOInputs inputs) {
    ...
    // Simplified logic since we removed the field simulation
  ...
  public boolean decrementBall(){
    // Since we aren't simulating the field/game pieces, this always returns false
    return false;
  }
