...
public class DeadzoneChooser {
  ...
  private Pair<Translation2d, Translation2d> otherAllianceDeadzone =
      new Pair<>(new Translation2d(9, 8.160), new Translation2d(9, 0));

  private final List<Pair<Translation2d, Translation2d>> threadTheNeedle =
      List.of( // blue alliance
          new Pair<>(new Translation2d(2, 8.171), new Translation2d(3.8, 6.7)),
          new Pair<>(new Translation2d(2, 5.8), new Translation2d(3.8, 0)));

  private final List<Pair<Translation2d, Translation2d>> threadTheNeedleGoTop =
      List.of( // blue alliance
          new Pair<>(new Translation2d(2, 7.42), new Translation2d(3.8, 0)));

  // Tune this
  private final List<Pair<Translation2d, Translation2d>> blockTop =
      List.of( // blue alliance
          new Pair<>(new Translation2d(2.686, 8.171), new Translation2d(4.585, 4.732)));

  private final List<Pair<Translation2d, Translation2d>> blockBottom =
      List.of( // blue alliance
          new Pair<>(new Translation2d(3.625, 3.784), new Translation2d(3.921, 0)));

  private final List<Pair<Translation2d, Translation2d>> blockStage =
      List.of( // blue alliance
          new Pair<>(new Translation2d(3.685, 5.615), new Translation2d(5.731, 2.817)));
  ...
  private List<Pair<Translation2d, Translation2d>> getBothAlliances(
      List<Pair<Translation2d, Translation2d>> blueObs) {
    ...
    for (Pair<Translation2d, Translation2d> pair : blueObs) {
      obs.add(
          new Pair<>(
              AllianceFlipUtil.apply(pair.getFirst()), AllianceFlipUtil.apply(pair.getSecond())));
    }
